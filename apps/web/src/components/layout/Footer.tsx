        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-20">
          <div className="lg:col-span-5 space-y-8">
            ...
            <p className="text-lg leading-relaxed max-w-sm text-slate-400">
              The intelligent platform for modern business reputation. From zero reviews to market
              dominance.
            </p>
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-12">
            ...
            <div>
              <h4 className="font-bold text-white mb-6 tracking-wide uppercase text-xs">
                Industry
              </h4>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between py-12 border-y border-white/5 gap-8 mb-12">
          <div className="text-left">
            ...
            <p className="text-sm text-slate-500">
              Get the latest reputation management tips delivered directly to your inbox.
            </p>
          </div>
          <div className="flex w-full md:w-auto gap-2">
            ...
            />
            <button className="btn-primary text-sm font-bold px-6 py-3 rounded-xl text-white">
              Subscribe
            </button>
          </div>
        </div>
