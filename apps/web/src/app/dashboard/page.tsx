...
import { Star, TrendingUp, MessageSquare, Clock, Zap, X, Send, Sparkles } from "lucide-react";
import {
  LineChart,
  Line,
  BarChart,
...
export default function DashboardPage() {
  ...
  const refresh = () => {
    ...
    setAnalytics(stats);
    setRecent(
      getReviewsByBusiness(biz.id)
        .filter((r) => !activeLocation || r.locationId === activeLocation.id)
        .slice(0, 6),
    );
  };
  ...
  const statCards = [
    {
      ...
      change: `+${analytics.newThisWeek} this week`,
    },
    {
    ...
    },
    {
      ...
      change: `${analytics.replied} replied`,
    },
    {
