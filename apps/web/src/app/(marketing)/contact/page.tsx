      ...
      <section className="w-full py-16 px-6 lg:px-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-12">
          {contactCards.map(({ icon: Icon, title, desc, href, display, gradient }) => (
            ...
            >
              <div
                className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${gradient} flex items-center justify-center mb-5 group-hover:scale-110 transition-transform`}
              >
        ...
        <div className="rounded-2xl border border-border bg-secondary/20 p-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="text-muted-foreground max-w-lg">
              ...
              <strong className="text-foreground">24 business hours</strong>. For urgent platform
              issues, include "URGENT" in your email subject line and we will prioritize your
              request.
            </p>
          </div>
          <a
