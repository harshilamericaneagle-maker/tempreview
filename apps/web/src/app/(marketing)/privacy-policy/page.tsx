...
You can control cookie settings through your browser preferences. Disabling cookies may affect certain features of our platform.`,
    },
    {
...
To exercise any of these rights, contact us at openize@gmail.com. We will respond within 30 days.`,
    },
    {
      ...
      content: `Our services are not directed to individuals under the age of 18. We do not knowingly collect personal information from children. If we become aware that a child has provided us with personal information, we will take steps to delete it promptly.`,
    },
    {
      title: "9. Changes to This Policy",
      content: `We may update this Privacy Policy from time to time. When we make significant changes, we will notify you by email or through a prominent notice on our platform at least 30 days before the changes take effect.`,
    },
    {
      title: "10. Contact Us",
      ...
      <section className="w-full py-16 px-6 lg:px-16">
        <div className="mb-10 p-6 rounded-2xl bg-primary/5 border border-primary/20 max-w-4xl">
          <p className="text-foreground leading-relaxed">
            At <strong>Openrize</strong>, your privacy is a top priority. This Privacy Policy
            explains how we collect, use, disclose, and protect information about you when you use
            our review management platform and related services. By using Openrize, you agree to the
