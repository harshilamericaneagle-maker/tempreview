...
export const metadata: Metadata = {
  ...
  description:
    "Read the Terms and Conditions governing your use of Openrize's review management platform.",
};
...
You are granted a limited, non-exclusive, non-transferable license to use the Service solely for your business's internal purposes in accordance with these Terms.`,
    },
    {
...
You are solely responsible for the content you submit and represent that you have all necessary rights to do so.`,
    },
    {
...
Any dispute arising out of or relating to these Terms or the Service shall first be attempted to be resolved through good-faith negotiation. If unresolved, disputes shall be submitted to binding arbitration in Cook County, Illinois.`,
    },
    {
...
Email: openize@gmail.com`,
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <PageHeader title="Terms & Conditions" description={`Last updated: ${lastUpdated}`} />

      <section className="w-full py-16 px-6 lg:px-16">
        <div className="mb-10 p-6 rounded-2xl bg-primary/5 border border-primary/20 max-w-4xl">
          <p className="text-foreground leading-relaxed">
            Please read these Terms and Conditions carefully before using the Openrize platform.
            These Terms constitute a legal agreement between you and <strong>Openrize</strong>{" "}
            governing your access to and use of our services.
          </p>
        </div>
        ...
        <div className="mt-12 p-6 rounded-2xl border border-border bg-secondary/20 text-center max-w-xl mx-auto">
