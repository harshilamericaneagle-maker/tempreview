...
const SEED_BUSINESSES: Business[] = [
  {
    ...
    category: "Restaurant",
    description:
      "A contemporary American bistro known for farm-to-table cuisine and an exceptional wine list.",
    phone: "(312) 555-0101",
  ...
  },
  {
    ...
    category: "Clinic",
    description:
      "Holistic wellness center offering chiropractic, acupuncture, and massage therapy.",
    phone: "(312) 555-0303",
  ...
  },
  {
    ...
    category: "Retail",
    description:
      "Modern lifestyle retail store featuring curated home goods and fashion accessories.",
    phone: "(312) 555-0404",
  ...
  const bistroReviews: SeedReview[] = [
    {
      ...
      rating: 5,
      text: "Absolutely incredible experience! The farm-to-table concept really shines here. Every dish was perfectly crafted and the wine pairing suggestions were spot on. The ambiance is stunning — will definitely be coming back!",
      reply:
        "Thank you so much, Sarah! We're thrilled you enjoyed the experience. Our chef puts so much love into every dish. We can't wait to welcome you back!",
      repliedAt: "2025-01-16T09:00:00Z",
      repliedBy: "Owner",
      status: "replied",
      sentiment: "positive",
      keywords: ["incredible", "farm-to-table", "wine", "ambiance"],
    ...
    },
    {
      ...
      rating: 5,
      text: "Best restaurant in Chicago, hands down. The truffle risotto is life-changing. Service was attentive but not intrusive. The entire evening felt like a 5-star hotel experience.",
      status: "pending",
      sentiment: "positive",
      keywords: ["best", "truffle risotto", "service", "5-star"],
    ...
    },
    {
      ...
      rating: 4,
      text: "Beautiful restaurant with excellent food. The scallops were divine. Only thing was our reservation was a bit delayed, but the staff handled it graciously with complimentary appetizers. Would return.",
      reply:
        "Thank you Emily! We sincerely apologize for the wait — your grace meant the world to us. Those scallops are a staff favorite too!",
      repliedAt: "2025-01-22T11:00:00Z",
      repliedBy: "Owner",
      status: "replied",
      sentiment: "positive",
      keywords: ["beautiful", "scallops", "reservation", "appetizers"],
    ...
    },
    {
      ...
      customerName: "Mike T.",
      rating: 3,
      text: "Food was great but a bit overpriced for the portion sizes. The cocktails were exceptional though. Might come back for drinks and appetizers rather than a full dinner.",
      status: "pending",
      sentiment: "neutral",
      keywords: ["overpriced", "portions", "cocktails", "exceptional"],
    ...
    },
    {
      ...
      customerName: "Lisa P.",
      rating: 5,
      text: "Celebrated our anniversary here and it was magical! The staff went above and beyond — they decorated our table and brought a complimentary dessert. Truly unforgettable.",
      reply:
        "Happy Anniversary, Lisa! We loved celebrating with you. It's moments like these that make our work so meaningful ❤️",
      repliedAt: "2025-02-01T10:00:00Z",
      repliedBy: "Owner",
      status: "replied",
      sentiment: "positive",
      keywords: ["anniversary", "magical", "staff", "dessert"],
    ...
    },
    {
      ...
      rating: 2,
      text: "Disappointed with my last visit. The pasta was overcooked and when I mentioned it, the waiter was dismissive. For these prices I expected much better service.",
      status: "pending",
      sentiment: "negative",
      keywords: ["disappointed", "overcooked", "dismissive", "prices"],
    ...
    },
    {
      ...
      customerName: "Anna W.",
      rating: 5,
      text: "Everything about this place is perfection. From the moment you walk in, the attention to detail is evident. The sommelier's recommendations were exceptional. A true gem in Chicago's dining scene.",
      status: "pending",
      sentiment: "positive",
      keywords: ["perfection", "sommelier", "detail", "gem"],
    ...
    },
    {
      ...
      customerName: "Tom B.",
      rating: 4,
      text: "Lovely dinner experience. The ribeye was cooked to perfection. Service was excellent and the atmosphere is romantic. Great for date nights. The noise level could be a bit lower though.",
      status: "pending",
      sentiment: "positive",
      keywords: ["ribeye", "service", "romantic", "atmosphere"],
    ...
    },
    {
      ...
      rating: 5,
      text: "Came here for a business dinner and was blown away. The private dining room was perfect, food was outstanding, and the service was impeccable. Definitely using this for future client meetings.",
      reply:
        "Thank you Rachel! We love hosting business events. Please ask about our private dining packages for future meetings!",
      repliedAt: "2025-02-19T09:00:00Z",
      repliedBy: "Owner",
      status: "replied",
      sentiment: "positive",
      keywords: ["business", "private dining", "outstanding", "impeccable"],
    ...
    },
    {
      ...
      rating: 3,
      text: "Food is good but parking situation is terrible. Took us 30 minutes to find parking. The restaurant should offer valet or at least provide better parking guidance.",
      status: "pending",
      sentiment: "neutral",
      keywords: ["parking", "terrible", "valet", "guidance"],
    ...
    },
    {
      ...
      rating: 5,
      text: "I visit every month and it never disappoints! The seasonal menu changes keep things exciting. This month's butternut squash ravioli was phenomenal. Staff recognizes me now — feels like family.",
      reply:
        "Jennifer, you're practically family at this point! We love your loyalty and can't wait to show you what's next on the seasonal menu!",
      repliedAt: "2025-02-25T10:00:00Z",
      repliedBy: "Owner",
      status: "replied",
      sentiment: "positive",
      keywords: ["seasonal", "ravioli", "loyalty", "family"],
    ...
    },
    {
      ...
      rating: 4,
      text: "Great spot for special occasions. The lamb chops were extraordinary. Reservation process was smooth. Wished the dessert menu was a bit more adventurous, but overall a wonderful evening.",
      status: "pending",
      sentiment: "positive",
      keywords: ["lamb chops", "extraordinary", "reservation", "dessert"],
      createdAt: "2025-03-01T18:30:00Z",
    },
  ];
  ...
  const liquorReviews: SeedReview[] = [
    {
      ...
      rating: 5,
      text: "The best selection of whiskey I've seen in any Chicago store. The staff is incredibly knowledgeable and helped me find the perfect bottle for my collection.",
      status: "pending",
      sentiment: "positive",
      keywords: ["whiskey", "selection", "knowledgeable", "collection"],
    ...
    },
    {
      ...
      rating: 4,
      text: "Great wine selection at competitive prices. The staff recommended an excellent Burgundy for our dinner party. Will be back for sure.",
      reply: "Thanks Maria! We're glad the Burgundy was a hit at your dinner party!",
      repliedAt: "2025-01-15T10:00:00Z",
      repliedBy: "Owner",
      status: "replied",
      sentiment: "positive",
      keywords: ["wine", "prices", "Burgundy", "dinner"],
    ...
    },
    {
      ...
      rating: 3,
      text: "Decent selection but the store layout makes it hard to find things. Prices on the craft beer section are higher than expected.",
      status: "pending",
      sentiment: "neutral",
      keywords: ["selection", "layout", "prices", "craft beer"],
    ...
    },
    {
      ...
      rating: 5,
      text: "Phenomenal shop! They sourced a rare Japanese whisky for me that I couldn't find anywhere else. Customer service is world-class.",
      status: "pending",
      sentiment: "positive",
      keywords: ["rare", "Japanese whisky", "customer service", "world-class"],
    ...
    },
    {
      ...
      customerName: "Pete R.",
      rating: 2,
      text: "Waited 20 minutes to get assistance. The staff seemed more interested in their phones than helping customers. Won't be going back.",
      status: "pending",
      sentiment: "negative",
      keywords: ["waited", "assistance", "staff", "phones"],
  ...
  const clinicReviews: SeedReview[] = [
    {
      ...
      rating: 5,
      text: "Dr. Chen is absolutely amazing! My chronic back pain has reduced by 80% after just 6 sessions. The clinic is spotless and the atmosphere is so calming.",
      reply:
        "Thank you Teresa! Your progress has been incredible to witness. We're so proud of your commitment!",
      repliedAt: "2025-01-20T09:00:00Z",
      repliedBy: "Owner",
      status: "replied",
      sentiment: "positive",
      keywords: ["Dr. Chen", "back pain", "spotless", "calming"],
    ...
    },
    {
      ...
      customerName: "Bob S.",
      rating: 4,
      text: "Very professional staff and effective treatment. The acupuncture sessions have helped with my migraines significantly. Scheduling could be a bit easier online.",
      status: "pending",
      sentiment: "positive",
      keywords: ["professional", "acupuncture", "migraines", "scheduling"],
    ...
    },
    {
      ...
      customerName: "Amy J.",
      rating: 5,
      text: "Bloom Wellness changed my life! After years of dealing with stress and tension, the massage therapy program has me feeling like a new person. Highly recommend!",
      status: "pending",
      sentiment: "positive",
      keywords: ["changed my life", "stress", "massage therapy", "recommend"],
    ...
    },
    {
      ...
      customerName: "Gary M.",
      rating: 3,
      text: "Treatments are effective but the wait times are too long. Had a 45-minute wait past my appointment time twice. Need to improve scheduling.",
      status: "pending",
      sentiment: "neutral",
      keywords: ["wait times", "appointment", "scheduling", "effective"],
...
const SEED_USERS: User[] = [
  ...
  {
    id: "user-staff-001",
    email: "jessica@stellarbistro.com",
    password: "pass1234",
    name: "Jessica Torres",
    role: "merchant",
    businessId: "biz-001",
  ...
  {
    id: "user-staff-004",
    email: "carlos@stellarbistro.com",
    password: "pass1234",
    name: "Carlos Mendez",
    role: "merchant",
    businessId: "biz-001",
...
const SEED_TASKS: IssueTask[] = [
  {
    ...
    businessId: "biz-001",
    reviewId: "rev-006",
    assignedToUserId: "user-staff-001",
    department: "housekeeping",
    issueType: "AC filter needs cleaning — room complaint",
    priority: "high",
    status: "open",
    roomNumber: "214",
    locationId: "loc-001",
  ...
  },
  {
    id: "task-s002",
    businessId: "biz-001",
    assignedToUserId: "user-staff-002",
    department: "maintenance",
    issueType: "Elevator noise reported by multiple guests",
    priority: "urgent",
    status: "in_progress",
    locationId: "loc-001",
    createdAt: daysAgo(5),
  ...
  },
  {
    ...
    issueType: "Check-in wait time too long — streamline process",
    priority: "medium",
    status: "open",
    locationId: "loc-001",
    createdAt: daysAgo(2),
  ...
  },
  {
    ...
    businessId: "biz-001",
    reviewId: "rev-010",
    assignedToUserId: "user-staff-003",
    department: "management",
    issueType: "Guest parking shortage — add valet option signage",
    priority: "medium",
    status: "in_progress",
    locationId: "loc-001",
    createdAt: daysAgo(7),
  ...
  },
  {
    ...
    assignedToUserId: "user-staff-002",
    department: "housekeeping",
    issueType: "Deep clean pool area — slippery tiles",
    priority: "urgent",
    status: "resolved",
    locationId: "loc-001",
    resolutionNote: "Non-slip mats installed and area re-cleaned.",
  ...
  },
  {
    id: "task-s006",
    businessId: "biz-001",
    assignedToUserId: "user-staff-004",
    department: "front_desk",
    issueType: "WiFi password not communicated at check-in",
    priority: "low",
    status: "resolved",
    locationId: "loc-002",
    resolutionNote: "Added WiFi info to welcome card printed at check-in.",
  ...
  },
  {
    ...
    assignedToUserId: "user-staff-003",
    department: "maintenance",
    issueType: "Replace burnt-out hallway lights Floor 3",
    priority: "medium",
    status: "resolved",
    locationId: "loc-002",
    resolutionNote: "Lights replaced on all F3 corridors.",
    createdAt: daysAgo(8),
    updatedAt: daysAgo(3),
  },
  {
    ...
    assignedToUserId: "user-staff-001",
    department: "housekeeping",
    issueType: "Mini-bar restocking inconsistency — room 118",
    priority: "low",
    status: "open",
    roomNumber: "118",
    locationId: "loc-001",
...
const SEED_ALERTS: Alert[] = [
  {
    ...
    businessId: "biz-001",
    reviewId: "rev-006",
    alertType: "1-star-review",
    severity: "critical",
    status: "active",
    message:
      "David L. left a 1-star review: 'The pasta was overcooked and the waiter was dismissive.' — Immediate response needed.",
    locationId: "loc-001",
    createdAt: daysAgo(5),
  },
  {
    ...
    status: "active",
    message:
      "Keyword 'disappointing' detected in 3 reviews this week — potential recurring issue with service quality.",
    locationId: "loc-001",
    createdAt: daysAgo(3),
  },
  {
    id: "alert-s003",
    businessId: "biz-001",
    alertType: "response-rate-drop",
    severity: "high",
    status: "acknowledged",
    message:
      "Response rate dropped 12% this week to 58%. You have 7 reviews pending response for over 48 hours.",
    locationId: "loc-002",
    createdAt: daysAgo(4),
  },
  {
    ...
    severity: "medium",
    status: "active",
    message: "7-day average rating at O'Hare location dipped to 3.9★ — below your 4.0★ threshold.",
    locationId: "loc-002",
    createdAt: daysAgo(2),
  },
  {
    id: "alert-s005",
    businessId: "biz-001",
    alertType: "competitor-overtake",
    severity: "medium",
    status: "acknowledged",
    message:
      "Marriott Downtown now leads your local market at 4.5★. You are currently ranked #2 with 4.4★.",
    locationId: "loc-001",
    createdAt: daysAgo(6),
  },
];
...
const SEED_CAMPAIGNS: ReviewRequestCampaign[] = [
  {
    ...
    templateBody:
      "Hi there! We hope you enjoyed your recent visit. If you have 60 seconds, we'd love to hear your feedback — it helps us improve and serve you better.",
    sendDelayHours: 24,
    isActive: true,
    sentCount: 142,
  ...
  },
  {
    ...
    channel: "sms",
    templateBody:
      "Thanks for staying with us! We'd love your feedback 🌟 Tap the link to leave a quick review: [REVIEW_LINK]",
    sendDelayHours: 2,
    isActive: true,
    sentCount: 89,
  ...
  },
  {
    ...
    templateBody:
      "Dear Guest, thank you for choosing our O'Hare location. Your opinion matters — please take a moment to share your experience with us.",
    sendDelayHours: 48,
    isActive: false,
    sentCount: 23,
...
export function getStaffStats(businessId: string) {
  ...
  return allUsers
    .map((u) => {
      const tasksResolved = allTasks.filter(
        (t) => t.assignedToUserId === u.id && t.status === "resolved",
      ).length;
...
export function addReview(
  data: Omit<Review, "id" | "createdAt" | "status" | "sentiment" | "keywords">,
): Review {
...
export function getPlatformAnalytics() {
  ...
  const avgPlatformRating = parseFloat(
...
export function addCampaign(
  data: Omit<ReviewRequestCampaign, "id" | "createdAt">,
